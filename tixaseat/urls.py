...
urlpatterns = [
    ...
    path('customer-delete-product/<int:pk>', views.customer_delete_product,name='customer-delete-product'),

    path('concert', views.concert_view, name='concert'),
    path('musical', views.musical_view, name='musical'),
